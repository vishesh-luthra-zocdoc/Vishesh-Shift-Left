...
test's name, what it tests, its concrete steps, a one-line summary, its level and scope, and a
...
|---|---|---:|---:|
| [`provider-billing/`](provider-billing/) | unit, integration, api | 72 | 763 |
| [`provider-fe-monorepo/`](provider-fe-monorepo/) | unit, e2e | 89 | 1093 |
| [`zocdoc_web/`](zocdoc_web/) | unit, integration, api, e2e | 279 | 3083 |
| **Total** | | **440** | **4939** |
...
|---|---|---:|---:|---|
| [`unit-test-mapping.md`](provider-billing/unit-test-mapping.md) | unit + component | 54 | 578 | `main` @ `166621f1c8` |
| [`integration-test-mapping.md`](provider-billing/integration-test-mapping.md) | integration | 13 | 88 | `main` @ `166621f1c8` |
| [`api-test-mapping.md`](provider-billing/api-test-mapping.md) | api | 5 | 97 | `main` @ `166621f1c8` |
...
| Mapping | Level | Test files | Rows | Revision |
|---|---|---:|---:|---|
| [`unit-test-mapping.md`](provider-fe-monorepo/unit-test-mapping.md) | unit + component | 82 | 1033 | `main` @ `9b3c308d21` |
| [`e2e-test-mapping.md`](provider-fe-monorepo/e2e-test-mapping.md) | e2e | 7 | 60 | `main` @ `9b3c308d21` |
...
| Mapping | Level | Test files | Rows | Revision |
|---|---|---:|---:|---|
| [`unit-test-mapping.md`](zocdoc_web/unit-test-mapping.md) | unit + component | 211 | 2411 | `master` @ `b306dc12f4` |
| [`integration-test-mapping.md`](zocdoc_web/integration-test-mapping.md) | integration | 20 | 381 | `master` @ `b306dc12f4` |
| [`api-test-mapping.md`](zocdoc_web/api-test-mapping.md) | api | 22 | 144 | `master` @ `b306dc12f4` |
| [`e2e-test-mapping.md`](zocdoc_web/e2e-test-mapping.md) | e2e | 26 | 147 | `master` @ `b306dc12f4` |

## How mappings are split

One file per **test level**, not per suite or per tool. Ordered cheapest and fastest first:

| File | Level | What lands here |
|---|---|---|
| `unit-test-mapping.md` | unit / component | Isolated logic with mocked collaborators. Component tests that render UI are marked **component**. Cron/scheduled-task handler tests live here too, marked **unit (cron handler)** — they are unit tests of a job, not a separate level. |
| `integration-test-mapping.md` | integration | Crosses a real boundary — SQL persistence, multi-collaborator flows. |
| `api-test-mapping.md` | api | Asserts HTTP request/response contracts. |
| `e2e-test-mapping.md` | e2e | Drives a real browser. The tool (Playwright or Selenium) is named in the document title, not the filename. |
...
| **Scope** | The level, the unit under test, and flags: `[Ignore]`, `skipped`, `.only`, `retry-on-fail`, `CI-gated`, combinatorial `[Values]`, and `CONDITIONAL assertion — can pass as a no-op`. |
