...
|---|---|---:|---:|
| [`provider-billing/`](provider-billing/) | api, cron, integration, unit | 72 | 763 |
| [`provider-fe-monorepo/`](provider-fe-monorepo/) | playwright, unit | 89 | 1093 |
| [`zocdoc_web/`](zocdoc_web/) | api, cron, integration, selenium, unit | 279 | 3083 |
| **Total** | | **440** | **4939** |

### [`provider-billing/`](provider-billing/)

`Zocdoc/provider-billing` — The billing service — .NET. All five test projects under `tests/` are mapped: `UnitTests`, `IntegrationTests`, `ApiTests`, `BillingExportCron.UnitTests`, and `SmokeTests` (one service-reachability test, rendered in the api mapping).
...
| [`cron-test-mapping.md`](provider-billing/cron-test-mapping.md) | L1 unit (cron) | 21 | 228 | `main` @ `166621f1c8` |
| [`integration-test-mapping.md`](provider-billing/integration-test-mapping.md) | L3 integration | 13 | 88 | `main` @ `166621f1c8` |
| [`unit-test-mapping.md`](provider-billing/unit-test-mapping.md) | L1/L2 unit + component | 33 | 350 | `main` @ `166621f1c8` |
...
| Mapping | Level | Test files | Rows | Revision |
|---|---|---:|---:|---|
| [`playwright-test-mapping.md`](provider-fe-monorepo/playwright-test-mapping.md) | L5 e2e (Playwright) | 7 | 60 | `main` @ `9b3c308d21` |
...
| [`cron-test-mapping.md`](zocdoc_web/cron-test-mapping.md) | L1 unit (cron) | 9 | 30 | `master` @ `b306dc12f4` |
| [`integration-test-mapping.md`](zocdoc_web/integration-test-mapping.md) | L3 integration | 20 | 381 | `master` @ `b306dc12f4` |
| [`selenium-test-mapping.md`](zocdoc_web/selenium-test-mapping.md) | L5 e2e (Selenium) | 26 | 147 | `master` @ `b306dc12f4` |
| [`unit-test-mapping.md`](zocdoc_web/unit-test-mapping.md) | L1/L2 unit + component | 202 | 2381 | `master` @ `b306dc12f4` |
...
Extractors and the renderer live in [`scripts/`](scripts/). Both extractors are validated
