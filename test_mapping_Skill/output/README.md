...
| Mapping | Level | Test files | Rows | Revision |
|---|---|---:|---:|---|
| [`zocdoc_web-api-billing-test-mapping.md`](zocdoc_web-api-billing-test-mapping.md) | L4 api | 22 | 144 | `master` @ `b306dc12f4` |
| [`zocdoc_web-cron-billing-test-mapping.md`](zocdoc_web-cron-billing-test-mapping.md) | L1 unit (cron) | 9 | 30 | `master` @ `b306dc12f4` |
| [`zocdoc_web-integration-billing-test-mapping.md`](zocdoc_web-integration-billing-test-mapping.md) | L3 integration | 20 | 381 | `master` @ `b306dc12f4` |
| [`zocdoc_web-selenium-billing-test-mapping.md`](zocdoc_web-selenium-billing-test-mapping.md) | L5 e2e (Selenium) | 26 | 147 | `master` @ `b306dc12f4` |
| [`zocdoc_web-unit-billing-test-mapping.md`](zocdoc_web-unit-billing-test-mapping.md) | L1/L2 unit + component | 202 | 2381 | `master` @ `b306dc12f4` |
...
matches `it`/`test` grep counts exactly (821 blocks / 82 files). See the verification notes in
[`CHANGELOG.md`](CHANGELOG.md) for the one known baseline limitation.
